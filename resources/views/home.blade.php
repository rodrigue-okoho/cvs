    ...
    <div class="col-mx-3 f-10" style="">
        ...
        <section class="mt-3 mx-2">
            ...
            <div class="description">
                <div>
                    <div class="l20">
                        <img class="" height="25" width="25" src="{{asset("images/tel.png")}}" alt=""/>
                    </div>
                    <div class="l80">
                ...
                <div>
                    <div class="l20">
                        <img class="" height="25" width="25" src="{{asset("images/mail.png")}}" alt=""/>
                    </div>
                    <div class="l80">
                ...
                <div>
                    <div class="l20">
                        <img class="img-thumbnail rounded-circle" height="25" width="25" src="{{asset("images/www.png")}}" alt=""/>
                    </div>
                    <div class="l80">
